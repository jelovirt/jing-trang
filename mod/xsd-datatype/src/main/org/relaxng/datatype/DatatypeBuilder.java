...
public interface DatatypeBuilder {
   ...
   * @param strValue The raw value of the parameter. Caller may not normalize
   *                 this value because any white space is potentially significant.
   * @param context  The context information which can be used by the callee to
   *                 acquire additional information. This context object is
   *                 valid only during this method call. The callee may not
   *                 keep a reference to this object.
   * @exception DatatypeException When the given parameter is inappropriate for some reason.
   ...
   *
   * @throws DatatypeException DatatypeException must be thrown if the derivation is
