...
public interface Datatype {
   ...
   *
   * @param literal the lexical representation to be checked.
   * @param context If this datatype is context-dependent
   ...
   * @return true if the 'literal' is a member of this Datatype;
   ...
   *
   * @throws DatatypeException If the given literal is invalid, then this exception is thrown.
   ...
   *                then the caller must provide a non-null valid context object.
   *                Otherwise, the caller can pass null.
   * @return null when the given lexical value is not a valid lexical
   * value for this type.
   */
   ...
   *
   * @return true if two value objects are considered equal according to
   ...
   *
   * @return If this datatype doesn't have any ID/IDREF semantics,
   ...
   *
   * @return <b>true</b> if this datatype is context-dependent
